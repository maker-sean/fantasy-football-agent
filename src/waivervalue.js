 ...
 *
 * SEPARATE FROM src/waivers.js ON PURPOSE. That module reads the BIDS as they
 * happen — won by a dollar, paid four times the field — and feeds the weekly
 * recap. This one asks a question that can only be answered months later: what
 * did the claim turn out to be worth. Same wire, opposite ends of the season,
 * and merging them would put live drama and hindsight in one place where only
 * the second needs a finished season to exist at all.
 *
