...
- waivers: what waiver claims and drops were worth — money wasted on a bust, free pickups that won weeks, and players dropped who then produced for somebody else. Arguments: manager=<name> (optional), season=<year> (optional). Use for "who wasted the most FAAB", "best waiver pickup ever", "worst drop", "who works the wire hardest", "biggest waiver bust".
